...
namespace Unlakki.Bns.Launcher.Core.Services
{
    ...
    {
        private ILauncherConfigDataProvider _configProvider;

        private ILauncherConfigParser _configParser;

        private LauncherConfig _launcherConfig;

        [ImportingConstructor]
        public LauncherConfigProvider(ILauncherConfigDataProvider configProvider, ILauncherConfigParser configParser)
        {
        ...
        private void ReadConfig()
        {
            try
            {
                string configText = _configProvider.Read();
        ...
        private void WriteConfig()
        {
            ...
            _configProvider.Write(configText);
        }
    }
}
