...
namespace BNSLauncher.Shared.Utils
{
    ...
    public static class RegistryHelper
    {
      ...
      '"'
        ...
        {
            return "Software\\Classes\\" + RegistryHelper.GetValidPathPart(schemeName);
        }
        ...
        {
            return Path.Combine(RegistryHelper.GetSoftwareLauncherRegistryFolder(publisher, launcherKey), "Games");
        }
